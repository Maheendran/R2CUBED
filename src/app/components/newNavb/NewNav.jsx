...
const NewNav = () => {
  return (
    <div
      ...
      <div className=" w-fit cursor-pointer h-full  relative flex justify-center gap-2 z-[1000]">
        <div className=" menubtn text-white bg-black  my-auto overflow-hidden  flex justify-center   h-full  z-[1000]">
          ...
          <div
            id=""
            className=" menuOne flex gap-3 absolute    top-0 bottom-0 my-auto w-[30vw] z-[-100]"
          >
