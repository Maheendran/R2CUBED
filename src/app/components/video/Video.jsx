...
const Video = () => {
  ...
  return (
    <div className="w-full mainbg  relative   ">
      <div className="w-full h-[5vh] md:h-[8.5vh] "></div>
      <div className="w-full h-[35vh]  md:h-[94.5vh]  relative flex  justify-center  m-auto">
        <div
          ref={ref}
          className="m-auto  z-20 w-[89%] md:w-[93%]  h-fit
          overflow-hidden   rounded-[20px] md:h-[85vh]   absolute top-0 bottom-0 left-0 right-0"
        >
          <div className=" h-full w-full relative  ">
            <video
              ...
              loop
              muted
              className=" w-full mx-auto h-full video-banner object-contain md:object-cover object-center"
              style={{
                objectFit: "cover",
                width: "100%",
                height: "100%",
