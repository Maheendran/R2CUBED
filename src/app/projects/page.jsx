...
<div className='w-[50%] h-full   flex justify-center'>
  <div className='w-[70%] relative h-[70%] border border-r-0 border-t-0 border-b-0 p-[3rem] text-white m-auto '>
...
R2CUBED is visionary in all its senses. We build state-of-the-art solutions leveraging the foundational principles of AI and Surveillance that can be tailored to your frame of reference</p>
 ...
 {/* ===side box */}
 <div className='h-[20vh] w-[0.7rem] bg-white absolute top-[20%] left-[-0.3rem] rounded-md'></div>
  </div>
</div>
