...
const Page = () => {
  return (
    <>
      ...
      {/* <div className="w-full h-fit  flex  flex-col-reverse justify-between relative"> */}
...
sm:leading-[2.8rem] ">
      ...
      <div className="w-[90%] text-justify flex  flex-col-reverse  relative h-fit p-[1rem] md:p-[3rem] text-black m-auto ">
        <div className="mt-[1.5rem] sm:mt-0 flex flex-col md:w-[60%] gap-4 ">
          <p className=" md:text-[1.4rem]   leading-[2.3rem]">
            ...
            automotive, warehousing, oil and gas, industrial gas production
            (CO2, O2, H2), food & beverage, industrial power plants, building
      ...
      {/* ===============second section=============== */}
      {/* text-[1.4rem] md:text-[1.5rem] sm:leading-[2.8rem]   */}
      <p className=" w-[85%] md:w-fit  mx-auto 
        ...
        >
          ...
          >
            <p>
              ...
              Company. R2C empowers manufacturing industries to transition from
              Industry 1.0 to 4.0 by automating their operations with IIOT
              sensors, Energy Management tools, Computer Vision systems, and
              deep tech tools such as ML, AI, AR, VR, etc. This enables
